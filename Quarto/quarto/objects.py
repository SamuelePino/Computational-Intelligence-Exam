    ...
    def run(self) -> int:
        ...
        while winner < 0 and not self.check_finished():
            ...
            while not piece_ok:
                ...
                if not piece_ok and self.__current_player == 0: print(f"Piece NOT VALID SCEMUNIT")
            piece_ok = False
            ...
            while not piece_ok:
                ...
                if not piece_ok and self.__current_player == 0: print("Place NOT VALID SCMEUNIT")
            print("IS_QUARTO SAYS: ", is_quarto(self.get_board_status()))
